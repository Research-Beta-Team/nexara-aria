  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: S[4] }}>
      ...
      <p style={{ fontFamily: F.body, fontSize: '12px', color: C.textSecondary, margin: 0, lineHeight: 1.5 }}>
        Every campaign makes Freya smarter. Your data stays private — only anonymised aggregate signals contribute to cross-client learning.
      </p>
    </div>
  );
}
