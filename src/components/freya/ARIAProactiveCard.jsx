...
const MOCK_BULLETS = [
  ...
  'Freya has 2 content pieces ready for your approval',
];

/**
 * Solo founder proactive trigger: "60-second brief" card shown once per day
 * on first app load. Mint border, [Open full brief →] opens FreyaWeeklyBrief modal.
