...
const FEATURE_DESC = {
  ...
  whiteLabel:           'Deliver Antarious under your own brand to clients.',
  apiAccess:            'Programmatic access to all Antarious data and actions.',
  ...
  subBilling:           'Bill clients directly through Antarious.',
