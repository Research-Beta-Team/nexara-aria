...
/* ─── Mock data ───────────────────────────────────────────── */
const INIT_THREADS = [
  { id: 't1', type: 'Campaigns', name: 'Medglobal VN CFO Q2 — Campaign Review', lastMsg: 'Freya: Campaign hitting 160% of MQL target...', time: '2:34 PM', unread: 3, tags: ['medglobal', 'cfq2', 'q2-2025'], participants: ['JD', 'LN', 'Freya'] },
  ...
  { id: 't3', type: 'Campaigns', name: 'APAC Brand Awareness — Q1 Review', lastMsg: 'Freya: Branded search up 34% vs 40% target', time: 'Feb 20', unread: 0, tags: ['apac', 'brand'], participants: ['LN', 'Freya'] },
  ...
  { id: 't6', type: 'Clients', name: 'Medglobal VN — Onboarding Checklist', lastMsg: 'Freya: KB docs uploaded and indexed', time: 'Feb 15', unread: 2, tags: ['medglobal', 'onboarding'], participants: ['JD', 'LN', 'Freya'] },
  ...
  { id: 't8', type: 'Agents', name: 'Email Sequencer — Config Update Request', lastMsg: 'Freya: Config change pending approval', time: '9:01 AM', unread: 0, tags: ['email-sequencer', 'config'], participants: ['Freya', 'LN'] },
  { id: 't9', type: 'Announcements', name: 'Platform Update — February 2025', lastMsg: 'Antarious: New agent capabilities released', time: 'Feb 1', unread: 1, tags: ['platform', 'update'], participants: ['Freya'] },
];
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: C.bg, overflow: 'hidden' }}>
      ...
      <div style={{ padding: `${S[5]} ${S[6]} ${S[4]}`, flexShrink: 0, borderBottom: `1px solid #1C2E22` }}>
        <h1 style={{ fontFamily: F.display, fontSize: '22px', fontWeight: 800, color: C.textPrimary, margin: 0, letterSpacing: '-0.03em' }}>
          Team Query
        </h1>
