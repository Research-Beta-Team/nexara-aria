...
export const dashboardByClient = {
  'medglobal': {
    ...
    freyaInsights: baseFreyaInsights,
  ...
  'glowup-cosmetics': {
    ...
    freyaInsights: clientOverrides['glowup-cosmetics'].freyaInsights,
    chartData: baseChartData,
  ...
  'techbridge-consulting': {
    ...
    escalationsSummary: [],
    metaStats: null,
    freyaInsights: baseFreyaInsights.slice(0, 2),
    chartData: baseChartData,
  ...
  'grameen-impact-fund': {
    ...
    freyaInsights: clientOverrides['grameen-impact-fund'].freyaInsights,
    chartData: baseChartData,
...
export const freyaInsights = baseFreyaInsights;
