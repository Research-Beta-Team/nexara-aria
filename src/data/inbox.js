...
James`,
    ...
    messages: [
      { id: 'm1', from: 'outbound', author: 'James D. (via Freya)', time: 'Feb 15 · 9:00 AM', body: "Hi Helen, I noticed Dragon Capital's recent expansion into Southeast Asia. We've helped 3 similar firms reduce overhead costs by an average of 34%. Would love to share how — open to a quick chat?", channel: 'LinkedIn' },
...
James`,
    ...
    messages: [
      { id: 'm1', from: 'outbound', author: 'Freya (Email Sequencer)', time: 'Feb 10 · 8:00 AM', body: "Subject: Quick question about SEA Corp's Q2 planning\n\nHi Marcus, I came across SEA Corp's recent expansion announcement and thought our platform could be timely for your team...", channel: 'Email' },
      { id: 'm2', from: 'outbound', author: 'Freya (Email Sequencer)', time: 'Feb 14 · 8:00 AM', body: "Subject: CFO Cost Reduction Playbook for Growth-Stage Firms\n\nHi Marcus, sharing the playbook I mentioned — 400+ CFOs contributed their top operational savings strategies.", channel: 'Email' },
...
James`,
    ...
    messages: [
      { id: 'm1', from: 'outbound', author: 'Freya (via James)', time: 'Feb 12 · 9:00 AM', body: "Hi Sarah, congratulations on the Series B! We help finance VPs like yourself automate operational reporting and surface budget optimization opportunities...", channel: 'LinkedIn' },
      { id: 'm2', from: 'outbound', author: 'Freya (via James)', time: 'Feb 17 · 9:00 AM', body: "Hi Sarah, following up — wanted to share a quick win from a recent client in real estate finance who saved 14 hours per week on consolidation.", channel: 'LinkedIn' },
...
Would love to show you a 15-minute demo — does this week work?`,
...

  {
    ...
    ariaClassification: {
      ...
      confidence: 99,
      reasoning: 'Auto-reply detected. Contact returns March 3. Freya has queued a follow-up email for March 4 at 8am.',
    },
...
James`,
    ...
    messages: [
      { id: 'm1', from: 'outbound', author: 'Freya (Email Sequencer)', time: 'Feb 19 · 8:00 AM', body: "Hi Priya, hope Q1 is off to a strong start! We work with Finance Directors at SaaS companies in the region to automate reporting and surface cost savings...", channel: 'Email' },
...
When are you free this week or next?`,
    ...
    messages: [
      ...
      { id: 'm5', from: 'outbound', author: 'James D. (via Freya)', time: 'Feb 21 · 3:22 PM', body: "Sending it now! Deck includes 3 telco case studies and a custom ROI model. Let me know when your team has had a chance to review.", channel: 'WhatsApp' },
    ],
  },
...
Would a pilot work for your situation? Happy to walk through the numbers on a quick call.`,
    ...
    messages: [
      { id: 'm1', from: 'outbound', author: 'Freya (Facebook)', time: 'Feb 18 · 10:00 AM', body: "Hi Mai! Thanks for engaging with our ad. We help finance leaders like yourself automate reporting and surface insights automatically. Would you like to see a quick demo?", channel: 'Facebook' },
