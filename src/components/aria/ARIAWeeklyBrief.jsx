...
const DISMISS_STORAGE_KEY = 'aria_brief_dismissed_week';
...
/**
 * Full Monday Morning Briefing: 4 sections (Action Required, Watch, Wins, ARIA Recommends)
    ...
    <div style={cardWrap}>
      ...
      <div style={{
        ...
        <div style={{ ...sectionBase, backgroundColor: actionBg, border: `1px solid rgba(255,110,122,0.2)` }}>
          <div style={sectionHeader('🔴', 'Action Required', brief?.action_required?.length)}>
        ...
        <div style={{ ...sectionBase, backgroundColor: watchBg, border: `1px solid rgba(245,200,66,0.2)` }}>
          <div style={sectionHeader('🟡', 'Watch', brief?.watch?.length)}>
        ...
        <div style={{ ...sectionBase, backgroundColor: winsBg, border: `1px solid rgba(61,220,132,0.2)` }}>
          <div style={sectionHeader('🟢', 'Wins This Week', brief?.wins?.length)}>
