...
export default function AriaPanelHistory({
  ...
  const folders = useStore((s) => s.ariaFolders) || [];
  const chats = useStore((s) => s.ariaChats) || [];
  const currentChatId = useStore((s) => s.ariaCurrentChatId);
  const addAriaFolder = useStore((s) => s.addAriaFolder);
  const removeAriaChat = useStore((s) => s.removeAriaChat);
  const moveAriaChatToFolder = useStore((s) => s.moveAriaChatToFolder);
