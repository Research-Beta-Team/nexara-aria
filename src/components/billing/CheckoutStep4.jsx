...
const FEAT_DESC = {
  ...
  whiteLabel:            { desc: 'Deliver Antarious under your own brand to clients.' },
  apiAccess:             { desc: 'Programmatic access to all Antarious data and actions.' },
  ...
  subBilling:            { desc: 'Bill clients directly through Antarious.' },
