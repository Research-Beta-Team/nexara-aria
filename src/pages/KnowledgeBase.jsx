          ...
          >
            ...
            >
              ...
              <button
                ...
                title={child.ariaApproved ? 'ARIA learns from this folder (click to disable)' : 'Allow ARIA to learn from this folder'}
                style={{
                  flexShrink: 0,
                  width: '28px',
                  height: '20px',
...
export default function KnowledgeBase() {
  ...
  const setAriaApproved = (folderId, approved) => {
    ...
    toast.info(approved ? 'ARIA can learn from this folder' : 'ARIA learning disabled for this folder');
  };
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: S[3] }}>
            <div>
              ...
              <p style={{ ...sectionSubheading, marginTop: S[1] }}>
                Documents and assets ARIA uses to power campaigns, messaging, and agents.
              </p>
            </div>
            <button
