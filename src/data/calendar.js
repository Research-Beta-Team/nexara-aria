...
export const CALENDAR_EVENTS = [
  ...
  },
  {
    ...
    description: 'Follow-up #2 to non-openers from Step 1. New subject line variant: "Quick question about your DPP roadmap". Includes short case study snippet from Medglobal.',
    channel: 'Email',
    status: 'scheduled',
  },
  {
  ...
  },
  {
    ...
    time: '11:00',
    type: 'social_post',
    title: 'LinkedIn carousel — Medglobal case study',
    description: '8-slide carousel: Medglobal achieved 340% pipeline increase in 90 days using Freya agents. Key metrics slide, testimonial quote, and CTA to book a demo.',
    channel: 'LinkedIn',
    status: 'scheduled',
  },
  ...
  },
  {
    ...
    description: 'Discovery + demo call. Sarah is evaluating 3 vendors. Key differentiator to emphasise: Freya agent automation and white-label reporting capability for her team.',
    channel: 'Zoom',
    status: 'scheduled',
  },
  {
  ...
  },
  {
    ...
    description: 'End-of-quarter client review. Presenting: pipeline influenced ($2.1M), leads generated (847), blended CPL, Freya agent activity log, and proposed Q2 strategy adjustments.',
    channel: 'Internal',
    status: 'scheduled',
  },
  ...
  // ── client_call (2) ─────────────────────────
  {
    ...
    time: '15:00',
    type: 'client_call',
    title: 'Strategy call — Medglobal — 3:00 PM',
    description: 'Monthly strategy call with Medglobal marketing team. Agenda: March pipeline review, content calendar sign-off, paid media performance dashboard walkthrough, Q2 planning.',
    channel: 'Zoom',
    status: 'scheduled',
  },
  {
    ...
    description: 'Q1 business review with Beta Dynamics leadership. Presenting: KPI scorecard, Freya agent activity breakdown, campaign ROI by channel, and proposed Q2 growth strategy.',
    channel: 'Zoom',
    status: 'scheduled',
  },
];
