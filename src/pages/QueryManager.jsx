...
/* ─── Mock data ───────────────────────────────────────────── */
const INIT_THREADS = [
  { id: 't1', type: 'Campaigns', name: 'Medglobal VN CFO Q2 — Campaign Review', lastMsg: 'ARIA: Campaign hitting 160% of MQL target...', time: '2:34 PM', unread: 3, tags: ['medglobal', 'cfq2', 'q2-2025'], participants: ['JD', 'LN', 'ARIA'] },
  ...
  { id: 't6', type: 'Clients', name: 'Medglobal VN — Onboarding Checklist', lastMsg: 'ARIA: KB docs uploaded and indexed', time: 'Feb 15', unread: 2, tags: ['medglobal', 'onboarding'], participants: ['JD', 'LN', 'ARIA'] },
...
const INIT_MESSAGES = {
  ...
  t6: [
    { id: 'm20', threadId: 't6', type: 'aria', author: 'ARIA', time: '3:00 PM', date: 'Feb 14, 2025', body: 'Medglobal VN onboarding initiated. KB docs have been uploaded and indexed:\n\n✓ Medglobal VN Company Brief\n✓ CFO Persona Card\n✓ Competitor Analysis\n\nCampaign agents are briefed and ready to launch once the campaign brief is approved.' },
