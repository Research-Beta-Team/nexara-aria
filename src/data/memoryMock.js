/**
 * Mock data for ARIA Persistent Memory (Session 1).
 * Four namespaces: brand, audience, campaigns, performance.
 * Each entry: { id, content, source, updatedAt }.
 * source: 'Manual' | 'ARIA-Detected' | 'Campaign Import' | 'CRM Sync'
 */
...
export const memoryMock = {
  brand: [
    ...
    { id: 'b2', content: 'Tone: Confident, data-driven, never salesy. Avoid buzzwords.', source: 'ARIA-Detected', updatedAt: twoHoursAgo },
  ...
  audience: [
    ...
    { id: 'a2', content: 'Champion: VP Marketing or CMO, reports to CEO, owns pipeline target', source: 'ARIA-Detected', updatedAt: twoHoursAgo },
  ...
  campaigns: [
    ...
    { id: 'c2', content: 'Google Search outperforms LinkedIn for mid-funnel (CPL 32% lower)', source: 'ARIA-Detected', updatedAt: twoHoursAgo },
  ...
  performance: [
    { id: 'p1', content: 'Baseline CPL: LinkedIn $180 | Google $95 | Meta $62', source: 'ARIA-Detected', updatedAt: twoHoursAgo },
    ...
    { id: 'p4', content: 'CAC target: $2,400 | Current: $2,850 (18% above target)', source: 'ARIA-Detected', updatedAt: twoHoursAgo },
  ],
};

/** Default empty structure for store initial state */
export function getInitialAriaMemory() {
  return {
