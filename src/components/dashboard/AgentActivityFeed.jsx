...
/**
 * Live feed of agent actions (workspace-active agents only).
 * Parent passes pre-filtered feed. LIVE dot, scrollable, max 300px.
 */
export default function AgentActivityFeed({ feed = [] }) {
  const cardStyle = {
        ...
        {feed.map((item, i) => (
          <div
            ...
            style={{
              ...
              borderLeft: `3px solid ${item.color || C.primary}`,
            }}
          >
